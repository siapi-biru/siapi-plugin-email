...
const getProviderSettings = () => {
  return siapi.plugins.email.config;
};

const send = async options => {
  return siapi.plugins.email.provider.send(options);
};
...
const sendTemplatedEmail = (emailOptions = {}, emailTemplate = {}, data = {}) => {
  ...
  return siapi.plugins.email.provider.send({ ...emailOptions, ...templatedAttributes });
};
