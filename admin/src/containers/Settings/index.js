          ...
          <form onSubmit={handleSubmit}>
            ...
            >
              <Text fontSize="md" lineHeight="18px">
                <FormattedMessage
                  ...
                  values={{
                    ...
                    link: (
                      <a
                        href="https://siapi.io/documentation/developer-docs/latest/development/plugins/email.html#configure-the-plugin"
                        target="_blank"
              ...
              <SizedInput
                ...
                size={{ xs: 6 }}
                type="select"
                value={`siapi-provider-email-${config.provider}`}
              />
            </FormBloc>
